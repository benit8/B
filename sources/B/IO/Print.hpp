...
template <usize N>
void print(Writer& wrt, const char* fmt, const Array<FormatArg, N>& args)
{}
...
/// Print to a Writer
template <typename... Args>
void print(Writer& wrt, const char* formatString, const Args&... args)
{
	const char* fmt = formatString;
	detail::print(wrt, fmt, Array<detail::FormatArg, sizeof...(args)>(args...));
}
...
{
	print(StdOut, formatString, args...);
}

/// Print to the standard output, with a newline
template <typename... Args>
void println(const char* formatString, const Args&... args)
{
	print(StdOut, formatString, args...);
	StdOut.put('\n');
}
...
{
	print(StdErr, formatString, args...);
}
...
{
	String output;
	auto writer = Writer::toString(output);
	print(writer, formatString, args...);
	return output;
}
